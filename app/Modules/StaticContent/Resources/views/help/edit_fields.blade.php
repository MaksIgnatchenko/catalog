...
<div class="form-group">
    ...
    <p>
        {!! Form::checkbox('status', $help->status, $help->isActive(), ['id' => 'statusCheckbox', 'class' => 'custom-checkbox']) !!}
...
<div class="form-group">
    <p>
        ...
        {!! Form::textarea('payload[' . LanguagesEnum::ENGLISH . ']', $help->getTranslation('payload', LanguagesEnum::ENGLISH, false), ['class' => 'form-control',  'maxlength' => 1000]) !!}
    </p>
...
<div class="form-group">
    <p>
        ...
        {!! Form::textarea('payload[' . LanguagesEnum::ARABIC . ']', $help->getTranslation('payload', LanguagesEnum::ARABIC, false), ['class' => 'form-control arabic_input',  'maxlength' => 1000]) !!}
    </p>
...
{{ Form::hidden('content_type', \App\Modules\StaticContent\Enums\ContentTypeEnum::HELP) }}
