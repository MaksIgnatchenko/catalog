...
<div class="form-group">
    ...
    <p>
        {!! Form::checkbox('status', $ourVision->status, $ourVision->isActive(), ['id' => 'statusCheckbox', 'class' => 'custom-checkbox']) !!}
...
<div class="form-group">
    <p>
        ...
        {!! Form::textarea('payload[' . LanguagesEnum::ENGLISH . ']', $ourVision->getTranslation('payload', LanguagesEnum::ENGLISH, false), ['class' => 'form-control',  'maxlength' => 1000]) !!}
    </p>
...
<div class="form-group">
    <p>
        ...
        {!! Form::textarea('payload[' . LanguagesEnum::ARABIC . ']', $ourVision->getTranslation('payload', LanguagesEnum::ARABIC, false), ['class' => 'form-control arabic_input',  'maxlength' => 1000]) !!}
    </p>
